...
namespace pdbget.Tests
{
    ...
    public class ConflictTests
    {
        ...
        public async Task DuplicateSinglelinePdb()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "4XT1 4XT1 4XT1" });
        ...
        public async Task DuplicateSinglelineUniProt()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "Q9Y5Y4 Q9Y5Y4 Q9Y5Y4" });
            int retCode = await Program.Main("-l", inputFile, "-o", outputDir);
        ...
        public async Task DuplicateSinglelineMixedFlatten()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "Q9Y5Y4 6D26 Q9Y5Y4 6D27 Q9Y5Y4 Q9Y5Y4 6D26 6D27" });
        ...
        public async Task DuplicatePdbLabeled()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "X:4XT1 4XT1 4XT1", "X:4XT1 4XT1", "X:4XT1" });
            int retCode = await Program.Main("-l", inputFile, "-o", outputDir);
        ...
        public async Task DuplicateUniProtLabeled()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "X:Q9Y5Y4 Q9Y5Y4 Q9Y5Y4", "X:Q9Y5Y4 Q9Y5Y4", "X:Q9Y5Y4" });
            int retCode = await Program.Main("-l", inputFile, "-o", outputDir);
        ...
        public async Task DuplicateMixedFlatten()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "Q9Y5Y4 6D26 Q9Y5Y4", "6D27 Q9Y5Y4", "Q9Y5Y4 6D26" });
            int retCode = await Program.Main("-l", inputFile, "-o", outputDir, "-f");
        ...
        public async Task MultipleTargets()
        {
            ...
            File.WriteAllLines(inputFile, new[] { "X:Q9Y5Y4 6D26 Q9Y5Y4 6D27", "6D27 Q9Y5Y4 6D26", "X:Q9Y5Y4 6D26" });
            int retCode = await Program.Main("-l", inputFile, "-o", outputDir);
