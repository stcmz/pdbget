...
namespace pdbget.Helpers
{
    public static class CsvHelper
    {
            ...
            params int[] columnIds)
        {
            ...
            foreach (var fields in rows.Skip(1).Select(o => o.SplitCsvFields(delimiter)))
            {
            ...
            params string[] columnNames)
        {
            ...
            var colIndicies = new int[columnNames.Length];
            int maxIndex = -1;
        ...
        {
            var headers = rows.First().SplitCsvFields().ToArray();
